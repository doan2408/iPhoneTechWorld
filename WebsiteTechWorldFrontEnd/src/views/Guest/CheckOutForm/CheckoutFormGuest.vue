...
watch(modalNewAddress, (val) => {
    shippingAddress.value.name = val.name;
    shippingAddress.value.phone = val.phone;
    shippingAddress.value.address = val.address;
}, { deep: true });
...
const updatePhiShip = async () => {
    ...
    const fullAddress = `${shippingAddress.value.address}`;
