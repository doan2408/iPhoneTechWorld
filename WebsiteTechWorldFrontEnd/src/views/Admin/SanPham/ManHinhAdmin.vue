<template>
  <div class="container mt-4">
    ...
    <el-dialog v-model="dialogVisible" :title="isEditMode ? 'Chỉnh sửa màn hình' : 'Thêm mới màn hình'" width="900px"
          ...
          <el-col :span="12">
            <el-form-item label="Tên màn hình" prop="tenManHinh">
              <el-input v-model="formData.tenManHinh"
                placeholder="Nhập tên màn hình (ví dụ: AMOLED, Retina, Dynamic Island...)" autocomplete="on" />
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="Loại màn hình" prop="loaiManHinh">
              <el-input v-model="formData.loaiManHinh" placeholder="Nhập loại màn hình (ví dụ: OLED, IPS, LCD)" />
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item label="Độ phân giải" prop="doPhanGiai">
              <el-input v-model="formData.doPhanGiai" placeholder="Nhập độ phân giải (ví dụ: 1080 x 2400 pixels)" />
            </el-form-item>
          </el-col>
        </el-row>
