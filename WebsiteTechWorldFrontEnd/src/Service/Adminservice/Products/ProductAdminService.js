...
export const findSanPhamBanHang = (
  tenSanPham,
  pageNo,
  pageSize,
  selectedIdKhachHang,
...
export const getAllSanPhamChiTiet = (pageNo, pageSize) =>
  fetchData(`/sanPhamChiTiet?page=${page}&size=${size}`);
...
export const getTrangThaiSanPham = (data) =>
  fetchData("/product/trang-thai", data);

export const getAllXuatXuPage = (page = 0, size = 5, search = "") =>
  fetchData(`/xuatXu/search?search=${search}&page=${page}&size=${size}`);
export const postXuatXu = (dataXuatXu) => postData("/xuatXu", dataXuatXu);
export const putXuatXu = (id, dataXuatXu) =>
  putData(`/xuatXu/${id}`, dataXuatXu);
export const deleteXuatXu = (idXuatXu) => deleteData(`/xuatXu/${idXuatXu}`);

export const getAllPinPage = (page = 0, size = 5, search = "") =>
  fetchData(`/pin/search?search=${search}&page=${page}&size=${size}`);
...
export const getAllRamPage = (page = 0, size = 5, search = "") =>
  fetchData(`/ram/search?search=${search}&page=${page}&size=${size}`);
...
export const getAllRomPage = (page = 0, size = 5, search = "") =>
  fetchData(`/rom/search?search=${search}&page=${page}&size=${size}`);
...
export const getAllNhaCungCapPage = (page = 0, size = 5, search = "") =>
  fetchData(`/nhaCungCap/search?search=${search}&page=${page}&size=${size}`);
...
export const getAllLoaiPage = (page = 0, size = 5, search = "") =>
  fetchData(`/loai/search?search=${search}&page=${page}&size=${size}`);
...
export const putManHinh = (id, dataManHinh) =>
  putData(`/manHinh/${id}`, dataManHinh);
export const deleteManHinh = (idManHinh) => deleteData(`/manHinh/${idManHinh}`);

export const getAllMauSacPage = (page = 0, size = 5, search = "") =>
  fetchData(`/mauSac/search?search=${search}&page=${page}&size=${size}`);
export const postMauSac = (dataMauSac) => postData("/mauSac", dataMauSac);
export const putMauSac = (id, dataMauSac) =>
  putData(`/mauSac/${id}`, dataMauSac);
...
export const postCameraTruoc = (dataCameraTruoc) =>
  postData("/cameraTruoc", dataCameraTruoc);
export const putCameraTruoc = (id, dataCameraTruoc) =>
  putData(`/cameraTruoc/${id}`, dataCameraTruoc);
export const deleteCameraTruoc = (idCameraTruoc) =>
  deleteData(`/cameraTruoc/${idCameraTruoc}`);

export const getAllCameraSauPage = (page = 0, size = 5) =>
  fetchData(`/cameraSau?page=${page}&size=${size}`);
export const postCameraSau = (dataCameraSau) =>
  postData("/cameraSau", dataCameraSau);
export const putCameraSau = (id, dataCameraSau) =>
  putData(`/cameraSau/${id}`, dataCameraSau);
export const deleteCameraSau = (idCameraSau) =>
  deleteData(`/cameraSau/${idCameraSau}`);

export const getAllNhaCungCapList = () => fetchData("/nhaCungCap/listNCC");
export const postNhaCungCapList = (data) =>
  postData("/nhaCungCap/quick-create", data);
...
export const postManHinhList = (data) =>
  postData("/manHinh/quick-manHinh", data);
...
export const getAllCameraTruocList = () =>
  fetchData("/cameraTruoc/listCameraTruoc");
export const postCameraTruocList = (data) =>
  postData("/cameraTruoc/cameraTruoc-quick", data);

export const getAllCameraSauList = () => fetchData("/cameraSau/listCameraSau");
export const postCameraSauList = (data) =>
  postData("/cameraSau/cameraSau-quick", data);

export const getAllModelSanPhamList = () =>
  fetchData("/modelSanPham/listModelSanPham");
export const getAllPageModelSanPham = (page = 0, size = 5) =>
  fetchData(`/modelSanPham?page=${page}&size=${size}`);

export const postModelSanPham = (data) => postData("/modelSanPham", data);

export const putModelSanPham = (id, data) =>
  putData(`/modelSanPham/${id}`, data);
export const deleteModelSanPham = (idModelSanPham) =>
  deleteData(`/modelSanPham/${idModelSanPham}`);
export const finByIdModelSanPham = (idModelSanPham) =>
  fetchData(`/modelSanPham/${idModelSanPham}`);

export const filterModelSanPham = (
  page = 0,
  size = 5,
  search = "",
  idLoai,
  ...
  if (idXuatXu !== null && idXuatXu !== undefined)
    params.append("idXuatXu", idXuatXu);
...
export const importExcelFileUpload = async (formData) => {
  try {
    const response = await api.post(
      "/admin/modelSanPham/import-excel/upload",
      formData,
      {
        headers: {
