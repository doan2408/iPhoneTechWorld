...
const sanPhamAdminRouters: RouteRecordRaw[] = [
      ...
      { path: "products/create", component: () => import("@/views/Admin/SanPham/createTest.vue") },
      { path: "products/create/modelSanPham", component: () => import("@/views/Admin/SanPham/testModelImport.vue") },
      ...
      { path: "products",name: "products", component: () => import("@/views/Admin/SanPham/ProductAdmin.vue"), meta: { title: 'Products Manage'} },
