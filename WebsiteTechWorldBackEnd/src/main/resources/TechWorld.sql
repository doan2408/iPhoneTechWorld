...
INSERT INTO hoa_don (id_khach_hang, id_phieu_giam_gia, ten_nguoi_mua, sdt, phi_ship, tong_tien, so_tien_giam, thanh_tien, ngay_tao, loai_hoa_don, ngay_thanh_toan, trang_thai_thanh_toan)
VALUES
    (1, 1, N'Nguyễn Thị Hoa', '0987654321', 30000.00, 20000000.00, 200000.00, 19830000.00, '2025-05-02', N'ONLINE', '2025-05-02', 'PENDING'),
    (2, 2, N'Trần Văn Hùng', '0976543210', 40000.00, 15000000.00, 200000.00, 14840000.00, '2025-04-20', N'POS', '2025-04-20', 'PENDING'),
    (3, NULL, N'Lê Thị Lan', '0965432109', 25000.00, 10000000.00, 0.00, 10025000.00, '2025-05-01', N'ONLINE', '2025-05-01', 'PAID'),
    (4, 4, N'Phạm Văn Minh', '0954321098', 35000.00, 25000000.00, 500000.00, 24535000.00, '2025-03-15', N'POS', '2025-03-15', 'PAID'),
    (5, 5, N'Hoàng Thị Ngọc', '0943210987', 30000.00, 18000000.00, 90000.00, 17940000.00, '2025-05-12', N'ONLINE', '2025-05-12', 'PAID');
...
INSERT INTO giao_hang (id_khach_hang, id_hoa_don, ten_nguoi_nhan, ngay_dat_hang, tong_gia_tri_don_hang, dia_chi_giao_hang, trang_thai_don_hang)
VALUES
    (1, 1, N'Nguyễn Thị Hoa', '2025-05-02', 19830000.00, N'123 Đường Láng, Hà Nội', N'PENDING'),
    (3, 3, N'Lê Thị Lan', '2025-05-01', 10025000.00, N'789 Trần Phú, Đà Nẵng', N'SHIPPING'),
    (5, 5, N'Hoàng Thị Ngọc', '2025-05-12', 17940000.00, N'202 Phạm Văn Đồng, Hà Nội', N'PACKED');
